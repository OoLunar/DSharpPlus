...
public sealed record InternalMessage
{
    ...
    /// </summary>
    /// <remarks>
    /// The author object follows the structure of the user object, but is only a valid user in the case where the message is generated 
    /// by a user or bot user. If the message is generated by a webhook, the author object corresponds to the webhook's id, username, and 
    /// avatar. You can tell if a message is generated by a webhook by checking the value of <see cref="WebhookId"/>.
    /// </remarks>
    [JsonPropertyName("author")]
    public required InternalUser Author { get; init; }
    ...
    public required IReadOnlyList<InternalUser> Mentions { get; init; } 

    /// <summary>
    /// The roles specifically mentioned in this message.
    /// </summary>
    [JsonPropertyName("mention_roles")]
    public required IReadOnlyList<InternalRole> MentionRoles { get; init; }
    ...
    public required IReadOnlyList<InternalAttachment> Attachments { get; init; } 

    /// <summary>
    /// The embedded content.
    /// </summary>
    [JsonPropertyName("embeds")]
    public required IReadOnlyList<InternalEmbed> Embeds { get; init; } 
    ...
    /// </summary>
    /// <remarks>
    /// For MESSAGE_CREATE and MESSAGE_UPDATE events, the message object may not contain a guild_id or member field since the 
    /// events are sent directly to the receiving user and the bot who sent the message, rather than being sent through the guild 
    /// like non-ephemeral messages.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// The member object exists in MESSAGE_CREATE and MESSAGE_UPDATE events from text-based guild channels, provided that the 
    /// message isn't ephemeral and the author of the message is not a webhook. This allows bots to obtain real-time member data 
